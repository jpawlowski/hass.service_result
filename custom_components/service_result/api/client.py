...
class ServiceResultEntitiesApiClientError(Exception):
    """Base exception to indicate a general API error."""


class ServiceResultEntitiesApiClientCommunicationError(
    ServiceResultEntitiesApiClientError,
):
    """Exception to indicate a communication error with the API."""


class ServiceResultEntitiesApiClientAuthenticationError(
    ServiceResultEntitiesApiClientError,
):
...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        ServiceResultEntitiesApiClientAuthenticationError: For 401/403 errors.
        aiohttp.ClientResponseError: For other HTTP errors.

    """
    if response.status in (401, 403):
        msg = "Invalid credentials"
        raise ServiceResultEntitiesApiClientAuthenticationError(
            msg,
        )
    response.raise_for_status()


class ServiceResultEntitiesApiClient:
    """
    ...
    async def async_get_data(self) -> Any:
        ...
        Raises:
            ServiceResultEntitiesApiClientAuthenticationError: If authentication fails.
            ServiceResultEntitiesApiClientCommunicationError: If communication fails.
            ServiceResultEntitiesApiClientError: For other API errors.
    ...
    async def _api_wrapper(
        ...
        try:
            ...
            raise ServiceResultEntitiesApiClientCommunicationError(
                msg,
            ) from exception
            ...
            raise ServiceResultEntitiesApiClientError(
                msg,
            ) from exception
