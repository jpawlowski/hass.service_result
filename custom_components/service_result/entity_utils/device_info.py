"""Device info utilities for service_result."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "Service Result Entities",
        manufacturer=manufacturer or "Service Result Entities",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('service_result', 'entry_id_value')}
    """
