"""Target humidity number for service_result."""

from __future__ import annotations

from typing import TYPE_CHECKING

from custom_components.service_result.api import ServiceResultEntitiesApiClientError
from custom_components.service_result.const import LOGGER
...
class ServiceResultEntitiesHumidityNumber(NumberEntity, ServiceResultEntitiesEntity):
    ...
    async def async_set_native_value(self, value: float) -> None:
        ...
        except ServiceResultEntitiesApiClientError as exception:
