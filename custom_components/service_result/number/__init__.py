"""Number platform for service_result."""
...
from .target_humidity import ENTITY_DESCRIPTIONS as HUMIDITY_DESCRIPTIONS, ServiceResultEntitiesHumidityNumber
...
async def async_setup_entry(
    ...
    async_add_entities(
        ServiceResultEntitiesHumidityNumber(
