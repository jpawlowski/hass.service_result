...
from custom_components.service_result.config_flow_handler.validators import validate_credentials
from custom_components.service_result.const import DOMAIN, LOGGER
...
ERROR_MAP = {
    "ServiceResultEntitiesApiClientAuthenticationError": "auth",
    "ServiceResultEntitiesApiClientCommunicationError": "connection",
}
