...
from custom_components.service_result.api import ServiceResultEntitiesApiClient
...
async def validate_credentials(hass: HomeAssistant, username: str, password: str) -> None:
    ...
    Raises:
        ServiceResultEntitiesApiClientAuthenticationError: If credentials are invalid.
