"""Connectivity binary sensor for service_result."""
...
class ServiceResultEntitiesConnectivitySensor(BinarySensorEntity, ServiceResultEntitiesEntity):
    """Connectivity sensor for service_result."""
