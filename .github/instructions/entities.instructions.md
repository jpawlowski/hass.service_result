...
- **`entity/`** - Base entity classes (inherit `ServiceResultEntitiesEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, ServiceResultEntitiesEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import ServiceResultEntitiesEntity`
