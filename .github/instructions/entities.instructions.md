...
- **`entity/`** - Base entity classes (inherit `ActionResultEntitiesEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, ActionResultEntitiesEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import ActionResultEntitiesEntity`
