...
- Inherit from `ServiceResultEntitiesEntity` and platform base class
...
- Entity: `custom_components/service_result/[platform]/[entity_name].py`
- Platform: `custom_components/service_result/[platform]/__init__.py`
