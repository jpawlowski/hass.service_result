...
- Inherit from `ActionResultEntitiesEntity` and platform base class
...
- Entity: `custom_components/action_result/[platform]/[entity_name].py`
- Platform: `custom_components/action_result/[platform]/__init__.py`
